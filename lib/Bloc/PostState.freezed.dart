...
class __$$intialImplCopyWithImpl<$Res>
    extends _$PostStateCopyWithImpl<$Res, _$intialImpl>
...
abstract class intial implements PostState {
...
class _$SuccessImpl implements Success {
  const _$SuccessImpl(
      {required final List<Post> posts, required this.hasReachedMax})
      : _posts = posts;
  ...
  @override
  String toString() {
    return 'PostState.success(posts: $posts, hasReachedMax: $hasReachedMax)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_posts), hasReachedMax);
...
abstract class Success implements PostState {
  const factory Success(
      ...
      required final bool hasReachedMax}) = _$SuccessImpl;
